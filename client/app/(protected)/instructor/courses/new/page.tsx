    ...
    <div className="mx-auto max-w-2xl py-8">
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-5">
        <div>
          ...
          <input id="title" name="title" required placeholder="e.g. React Fundamentals" className="mt-1 block w-full rounded-lg border px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-primary" />
        </div>

        <div>
          <label htmlFor="description" className="text-sm font-medium">Description <span className="text-red-500">*</span></label>
          <textarea id="description" name="description" rows={4} required placeholder="What will students learn?" className="mt-1 block w-full rounded-lg border px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-primary" />
        </div>
