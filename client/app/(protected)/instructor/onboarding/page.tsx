  ...
  return (
    <div className="mx-auto max-w-2xl py-12">
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-5">
        <div>
          <label htmlFor="headline" className="text-sm font-medium">Headline <span className="text-red-500">*</span></label>
        ...
        <div>
          ...
          <textarea id="experience" name="experience" rows={3} placeholder="Briefly describe your professional background..." className="mt-1 block w-full rounded-lg border px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-primary" />
        </div>
        <fieldset className="border-t pt-5">
          ...
          <div className="mt-3 grid gap-4 sm:grid-cols-2">
            <div>
              ...
              <input id="twitter" name="twitter" placeholder="https://twitter.com/..." className="mt-1 block w-full rounded-lg border px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-primary" />
            </div>
            <div>
            ...
            <div>
              ...
              <input id="github" name="github" placeholder="https://github.com/..." className="mt-1 block w-full rounded-lg border px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-primary" />
            </div>
            <div>
